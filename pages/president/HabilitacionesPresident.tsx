...
export const HabilitacionesPresident = ({ consuladoId, consuladoName }: { consuladoId: string, consuladoName: string }) => {
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8 pb-20 px-4 animate-boca-entrance">
        ...
        {showConfirmSubmit && (
            <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4 bg-[#001d4a]/50 backdrop-blur-sm animate-in fade-in zoom-in-95 duration-200" style={{ paddingTop: 'calc(7rem + 1rem)', paddingBottom: '1rem' }}>
